...
const constants_2 = require("../member-welcome-emails/constants");
...
class GiftService {
    ...
    async redeem(token, memberId, options = {}) {
        const run = async (transacting) => {
            ...
            await this.deps.memberRepository.enqueueWelcomeEmailRun(memberId, constants_2.MEMBER_WELCOME_EMAIL_SLUGS.paid, { transacting });
