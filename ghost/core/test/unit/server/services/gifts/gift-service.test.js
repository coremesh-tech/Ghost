...
describe('GiftService', function () {
    ...
    beforeEach(function () {
        ...
        memberRepository = {
            ...
            enqueueWelcomeEmailRun: sinon_1.default.stub().resolves(undefined)
        };
        staffServiceEmails = {
    ...
    describe('redeem', function () {
        ...
        it('enqueues the paid welcome email run for a new gift signup', async function () {
            ...
            sinon_1.default.assert.calledOnceWithExactly(memberRepository.enqueueWelcomeEmailRun, 'member_1', 'member-welcome-email-paid', { transacting: 'trx' });
        });
        ...
        it('passes the external transaction through to the welcome email enqueue', async function () {
            ...
            sinon_1.default.assert.calledOnceWithExactly(memberRepository.enqueueWelcomeEmailRun, 'member_1', 'member-welcome-email-paid', { transacting: externalTrx });
        });
    });
